...
export default function CafeSignUpPage() {
  ...
  return (
    <div
      className="w-full max-w-lg rounded-xl shadow-lg p-6 sm:p-8 bg-white"
      data-testid="cafe-signup-page"
    >
      ...
      />
      <form onSubmit={handleSubmit(onSubmit)} data-testid="cafe-signup-form">
